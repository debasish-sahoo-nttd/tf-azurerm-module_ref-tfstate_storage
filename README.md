# tf-azurerm-module_ref-tfstate_storage

This module is a reference architecture module to store terraform state files in azure storage account. It is capable to provision multiple storage accounts in a single resource group with multiple containers in each storage account.
